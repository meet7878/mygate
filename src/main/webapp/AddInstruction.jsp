...
<body>
	...
	<div class="container">
		<form class="form-horizontal" role="form" action="AddinstructionController"
			method="post">
					...
					<div class="row">
						<div class="col-sm-4">
							<label class="radio-inline"> <input type="radio"
								id="femaleRadio" value="yes" name="per"
								>yes
							</label>
						</div>
						<div class="col-sm-4">
							<label class="radio-inline"> <input type="radio"
								id="maleRadio" value="no" name="per"
								>No
							</label>
						</div>
